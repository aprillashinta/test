...
export default function FormLogin() {
    ...
    return (
        <div>
            ...
            <div className='mt-3'>
                <button className='btn bg-[#FF9738] hover:bg-orange-500 w-full text-white' onClick={() => router.push('/')}>LOGIN</button>
            </div>
            ...
            <div className='flex justify-center'>
                <label className='text-center'>Don't have an account ? <a className='text-orange-500'>Register</a> </label>
